...
for nl in range(NLATS):
    ...
    #         filename = "results_checkStyles/plots/plots_" + str(nl).zfill(2) + "_inter_" + str(ninter) + "_res_" + str(res).zfill(3) + ".png"
    ...
    for glayer in listInterp:
        for ninter in range(NINTER):
            ...
            # w2 = tf.random.uniform([LATENT_SIZE], minval=0.0, maxval=1.0)
