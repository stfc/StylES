...
<<<<<<< HEAD
            resREC, resLES, resDNS, UVP_DNS, loss_fil = step_find_latents_DNS(wl_synthesis, filter, opt_DNS, w0, w1, imgA, fimgA, ltv_DNS)
=======
...
>>>>>>> main
    ...
    for kk in range(RES_LOG2-FIL, RES_LOG2+1):
        ...
        # save fields
        filename = "results_latentSpace/fields/fields_lat_"  + str(k) + "_res" + str(res) + ".npz"
